package com.demo.kafka.boot.spring.Stream;

import java.util.Properties;

import com.demo.kafka.boot.spring.utils.TestUtils;
...
public class WordCountLambdaService {
     ...
     */
    public void createWordCountStream(final StreamsBuilder builder) {
